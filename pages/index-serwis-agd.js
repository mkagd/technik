...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Przełącznik wersji + wybór miast */}
      <div className="fixed bottom-4 left-4 z-50 flex flex-col gap-2 max-h-[80vh] overflow-y-auto p-2 bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm rounded-lg shadow-xl">
        <div className={`text-xs ${colors.textTertiary} font-medium mb-1 px-2`}>🏠 Wybierz Wersję:</div>
